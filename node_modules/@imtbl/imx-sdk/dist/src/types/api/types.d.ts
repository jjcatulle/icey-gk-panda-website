...
export declare namespace ImmutableMethodParams {
    ...
    const ImmutableCancelOrderParamsCodec: t.TypeC<{
        starkPublicKey: t.BrandC<t.StringC, import("../runtime").HexadecimalStringBrand>;
        orderId: t.BrandC<t.BrandC<t.StringC, import("../runtime").NumberStringBrand>, import("../runtime").PositiveIntegerStringBrand>;
    }>;
    type ImmutableCancelOrderParams = t.TypeOf<typeof ImmutableCancelOrderParamsCodec>;
    ...
    const ImmutableGetOrdersParamsCodec: t.IntersectionC<[t.PartialC<{
        ...
        buy_token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
        buy_token_id: t.StringC;
        buy_token_contract: t.UnionC<[t.BrandC<t.StringC, import("../runtime").EthAddressBrand>, t.StringC]>;
        ...
        sell_token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
    ...
    const ImmutableGetTransactionParamsCodec: t.IntersectionC<[t.PartialC<{
        ...
        min_timestamp: t.StringC;
        max_timestamp: t.StringC;
        token_type: t.UnionC<[t.Type<import("../runtime").ERC721TokenType, import("../runtime").ERC721TokenType, unknown>, t.Type<import("../runtime").ETHTokenType, import("../runtime").ETHTokenType, unknown>, t.Type<import("../runtime").MintableERC20TokenType, import("../runtime").MintableERC20TokenType, unknown>, t.Type<import("../runtime").MintableERC721TokenType, import("../runtime").MintableERC721TokenType, unknown>]>;
        token_id: t.StringC;
