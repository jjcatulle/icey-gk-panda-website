...
export declare class ImmutableXClient {
    ...
    private agent;
    private requests;
    constructor(publicApiUrl: string, wallet: ImmutableXWallet, contractAddress: EthAddress, registrationContractAddress: EthAddress, _address: EthAddress, _starkPublicKey: HexadecimalString, enableDebug?: boolean);
    ...
    static build({ publicApiUrl, signer, starkContractAddress, registrationContractAddress, gasLimit, gasPrice, enableDebug, }: ImmutableXClientParams): Promise<ImmutableXClient>;
    ...
    createOrderRequestF({ user, tokenSell, tokenBuy, amountSell, amountBuy, include_fees, fees, }: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, {
    ...
    createOrderF(params: ImmutableMethodParams.ImmutableGetSignableOrderParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableCreateOrderResult>;
    private checkExperimentalFeesParams;
    ...
    createExchange(walletAddress: string): Promise<ImmutableMethodResults.ImmutableCreateExchangeResult>;
    getExchange(exchange_id: string): Promise<ImmutableMethodResults.ImmutableGetExchangeResult>;
    getMoonpaySignature(request: string): Promise<ImmutableMethodResults.ImmutableGetMoonpaySignatureResult>;
